...
RestRequest req1 = new RestRequest("https://localhost:7204/api/Name/authenticate", Method.Post);
...
RestRequest req2 = new RestRequest("https://localhost:7204/api/Name", Method.Get);
